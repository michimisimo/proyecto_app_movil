...
export function validarPerfilUsuario (perfilUsuario: PerfilUsuario, passwordConfirm: String, inputUsuario: HTMLInputElement, 
  ...
  validarLongitudUsuario(perfilUsuario.user.usuario, error, inputUsuario);
  ...
  const retornoLargo = validarLongitudPassword(perfilUsuario.user.password, error, inputPassword, inputPassConfirm);
  //validar coincidencia entre constraseña y confirmar contraseña
  const retornoCoincidencia = validarCoincidenciaPasswords(perfilUsuario.user.password, error, inputPassword, inputPassConfirm, passwordConfirm);
